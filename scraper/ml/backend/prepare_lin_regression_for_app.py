...
# From linear_regression_log.csv, about 0.64 R2
best_lr = 0.5
best_reg = 0.5
best_iter = 10000
...
model = lin_reg.LinearRegression(lin_reg_data, lin_reg_result, best_lr, best_iter, best_reg
                                 , min_standardization=min_val
                                 , max_standardization=max_val)
